      ...
      <div className="fixed top-4 left-0 w-full z-50 px-4 md:px-8 flex justify-center pointer-events-none">
        ...
        >
          <a href="#" className="flex items-center group">
            <div className="relative w-20 h-20 sm:w-28 sm:h-28 md:w-36 md:h-36 -my-4 sm:-my-8 md:-my-11 overflow-hidden transition-transform duration-500 group-hover:scale-105">
              {/* Light Theme Logo */}
              <Image
