    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="info-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="info-card card-premium p-8 rounded-2xl glass border border-black/5 dark:border-white/5 hover:border-[#007799]/30 dark:hover:border-[#00f0ff]/30 group">
            <div className="w-12 h-12 rounded-xl bg-[#007799]/10 dark:bg-[#00f0ff]/10 flex items-center justify-center mb-6 group-hover:bg-[#007799]/20 dark:group-hover:bg-[#00f0ff]/20 icon-glow-primary transition-all duration-300">
          ...
          {/* Card 2: Transport */}
          <div className="info-card card-premium p-8 rounded-2xl glass border border-black/5 dark:border-white/5 hover:border-[#ff6b4a]/30 transition-all duration-300 group">
            <div className="w-12 h-12 rounded-xl bg-[#ff6b4a]/10 flex items-center justify-center mb-6 group-hover:bg-[#ff6b4a]/20 icon-glow-accent transition-all duration-300">
          ...
          <div className="info-card card-premium p-8 rounded-2xl glass border border-black/5 dark:border-white/5 hover:border-purple-500/30 transition-all duration-300 group">
            <div className="w-12 h-12 rounded-xl bg-purple-500/10 flex items-center justify-center mb-6 group-hover:bg-purple-500/20 shadow-[0_0_15px_rgba(168,85,247,0.25)] transition-all duration-300">
        ...
        <div className="info-card mt-12 p-8 rounded-2xl bg-[#007799]/5 dark:bg-gradient-to-r dark:from-[#0a1b2c] dark:to-[#040e18] border border-black/5 dark:border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a
            href="#contact"
            className="px-6 py-3.5 btn-premium-primary text-xs flex-shrink-0"
          >
